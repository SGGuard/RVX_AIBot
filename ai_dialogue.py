...
def build_dialogue_system_prompt() -> str:
    """Системный промпт для ИИ - объясняет простыми словами и показывает влияние на рынки."""
...
1️⃣ ЕСЛИ ЭТО НОВОСТЬ - ВСЕГДА ПОКАЗЫВАЙ ВЛИЯНИЕ НА РЫНКИ:
   "Что произошло?" → "Почему это важно?" → "Как это влияет на цены?"
   
2️⃣ ОБЪЯСНЯЙ ПРОСТЫМИ СЛОВАМИ:
...
3️⃣ СТРУКТУРА ОТВЕТА (максимум 5 коротких абзацев):
