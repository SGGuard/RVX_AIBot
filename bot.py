    ...
    if data.startswith("clarify_"):
        ...
        try:
            ...
            exploration_question = (
                ...
                f"2. Генерируй ДЕЙСТВИТЕЛЬНО НОВЫЙ факт или угол\n"
                f"3. Делай интересным для чтения - как история, не как учебник\n"
                f"4. Объясняй простыми словами, используй конкретные примеры\n"
                f"5. Максимум 450 символов - кусочек информации за раз\n"
                f"6. Используй USD/EUR в примерах (не рубли)\n"
                f"7. Если информацию трудно найти - придумай аналогию"
            )
