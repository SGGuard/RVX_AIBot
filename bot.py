...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text = (
        f"<b>╔════════════════════════════════════════╗</b>\n"
        f"<b>║     🚀 RVX AI - Крипто Ассистент      ║</b>\n"
        f"<b>║  Анализ • Обучение • Калькулятор     ║</b>\n"
        f"<b>╚════════════════════════════════════════╝</b>\n\n"
        
        f"👋 {adaptive_greeting}\n\n"
        
        f"<b>🎯 Что я могу делать:</b>\n"
        f"🧠 <b>Анализ новостей</b> - Изучай крипто новости с умным анализом\n"
        f"📚 <b>Обучение</b> - 3 курса + 50+ уроков по блокчейну и Web3\n"
        f"🧮 <b>Калькулятор</b> - Расчеты рыночной стоимости токенов\n"
        f"🎓 <b>Интерактивные задачи</b> - Зарабатывай XP и бейджи\n"
        f"📊 <b>Статистика</b> - Отслеживай прогресс и достижения\n"
        f"📋 <b>Ресурсы</b> - Лучшие материалы для обучения\n\n"
        
        f"<b>⭐ Возможности:</b>\n"
        f"• 🏆 Топ-10 лидерборд с реальными наградами\n"
        f"• 💡 Советы по защите от манипуляций\n"
        f"• 🔔 Уведомления о NFT дропах и активностях\n"
        f"• 📌 Сохранение и экспорт анализов\n"
    ...
    if MANDATORY_CHANNEL_ID:
        welcome_text += f"\n📢 Подпишись на канал: {MANDATORY_CHANNEL_LINK}\n"
    ...
    if data == "airdrops_quiz":
        ...
        try:
            await query.edit_message_text(
                ...
                "<b>1. Что никогда нельзя давать в аирдропе?</b>\n"
                "❌ Email\n"
                "❌ Номер телефона\n"
                "✅ <code>Приватный ключ</code> - НИКОГДА!\n\n"
                
                "<b>2. Сколько примерно стоит средний аирдроп?</b>\n"
                "❌ $1000+\n"
                "✅ $5-50 - ОБЫЧНО\n"
                "❌ Миллион\n\n"
                
                "<b>3. Где начать если я новичок?</b>\n"
