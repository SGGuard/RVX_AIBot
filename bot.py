...
async def send_comprehensive_analysis(
    ...
    Returns:
        None
    """
    message = f"<b>🔬 ПОЛНЫЙ КОМПЛЕКСНЫЙ АНАЛИЗ: {title}</b>\n"
    message += "═" * 70 + "\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    """
    help_text = (
        "<b>📖 ПОЛНОЕ РУКОВОДСТВО ПО RVX BOT v0.26.5</b>\n"
        "═" * 60 + "\n\n"
        
        "<b>🎯 ЧТО МОЖЕТ ДЕЛАТЬ БОТ (ОЧЕНЬ РАСШИРЕНО):</b>\n"
        "1. 📰 ПОЛНЫЕ анализы криптоновостей и трендов\n"
        "2. 🎓 ПОДРОБНОЕ обучение (интерактивные уроки, гайды)\n"
        "3. 🎮 ГЕЙМИФИЦИРОВАННОЕ обучение (квесты, достижения, уровни)\n"
        "4. 📊 ДЕТАЛЬНОЕ отслеживание твоего прогресса\n"
        "5. 💬 ИНТЕРАКТИВНЫЕ диалоги с вопросами и примерами\n"
        "6. 🔬 ГЛУБОКИЕ экспертные анализы с разных сторон\n\n"
        
        "<b>🚀 ГЛАВНЫЕ КОМАНДЫ:</b>\n\n"
        
        "<b>/teach [тема] [уровень]</b>\n"
        "   → ИНТЕРАКТИВНЫЙ учитель по крипто, AI, Web3, трейдингу\n"
        "   → РАЗВЕРНУТЫЕ уроки с примерами, вопросами, практикой!\n"
        ...
        "<b>/learn</b>\n"
        "   → ПОЛНЫЕ структурированные образовательные курсы\n"
        "   → Со всеми деталями, примерами и вопросами\n"
        "   • Blockchain основы с примерами\n"
        "   • DeFi контракты пошагово\n"
        "   • Масштабирование, DAO, Web3 экосистема\n\n"
        
        "<b>/tasks</b>\n"
        "   → ЕЖЕДНЕВНЫЕ КВЕСТЫ для обучения\n"
        "   • Получай XP за правильные ответы\n"
        "   • Открывай новые достижения и бейджи\n"
        "   • Повышай уровень и разблокируй новые функции\n\n"
        
        "<b>/stats</b>\n"
        "   → ТВОЯ ПОЛНАЯ СТАТИСТИКА И ДОСТИЖЕНИЯ\n"
        "   • XP, уровень, прогресс обучения\n"
        "   • Пройденные уроки и курсы\n"
        "   • Заработанные бейджи и награды\n"
        "   • Твой рейтинг среди других\n\n"
        
        "<b>📰 АНАЛИЗ НОВОСТЕЙ (МАКСИМАЛЬНО РАЗВЕРНУТЫЙ):</b>\n"
        "   Просто отправь текст криптоновости → получишь:\n"
        "   • ПОЛНОЕ объяснение на русском\n"
        ...
        "<b>🔬 НОВОЕ: ЭКСПЕРТНЫЕ ФУНКЦИИ</b>\n"
        "   Когда бот дает ответ, он теперь использует:\n"
        "   ✓ ПОЛНЫЙ эксперт-уровень анализ\n"
        "   ✓ ГЛУБОКИЕ инсайты профессионалов\n"
        "   ✓ РЕАЛЬНЫЕ примеры и кейсы\n"
        "   ✓ ВОПРОСЫ для твоего размышления\n"
        "   ✓ ДОРОЖНАЯ КАРТА дальнейшего обучения\n"
        "   ✓ ССЫЛКИ на дополнительные ресурсы\n"
        "   ✓ ИСТОРИЧЕСКОЕ развитие темы\n"
        "   ✓ ТИПИЧНЫЕ ошибки, которые надо избегать\n\n"
        
        "<b>📚 ДОПОЛНИТЕЛЬНЫЕ КОМАНДЫ:</b>\n"
        "   /lesson — продолжить текущий урок\n"
        "   /history — последние анализы (со всеми деталями!)\n"
        "   /search [текст] — поиск в истории\n"
        "   /bookmarks — сохраненные анализы\n"
        "   /export — скачать полную историю\n"
        "   /limits — твои лимиты запросов\n"
        "   /menu — быстрое меню\n"
        "   /drops — NFT дропы и новые проекты\n"
        "   /activities — активности в крипто проектах\n\n"
        
        "<b>⚡ ТВОИ ЛИМИТЫ:</b>\n"
        f"   • {MAX_REQUESTS_PER_DAY} анализов в день\n"
        f"   • {FLOOD_COOLDOWN_SECONDS}с между запросами\n"
        f"   • Макс. текст: {MAX_INPUT_LENGTH} символов\n"
        "   • КУРСЫ, УРОКИ И КВЕСТЫ - БЕЗ ЛИМИТОВ!\n"
        "   • Повышай уровень - получи больше лимитов!\n\n"
        ...
        "   ✓ Повышай уровень - разблокируй премиум функции\n"
        "   ✓ Читай ПОЛНЫЕ ответы бота - там вся информация!\n\n"
        
        "<b>🎯 ПРИМЕРЫ ИСПОЛЬЗОВАНИЯ:</b>\n"
        "   1. /teach crypto_basics — основы крипто\n"
        "   2. /teach trading beginner — трейдинг для новичков\n"
        "   3. /teach web3 advanced — Web3 продвинутый курс\n"
        "   4. /tasks — пройти ежедневный квест\n"
        "   5. /stats — проверить свой полный прогресс\n"
        "   6. \"Что произойдет с Bitcoin?\" — получить развернутый анализ\n\n"
        
        "<b>❓ ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ:</b>\n"
        "   Q: Почему ответы такие длинные?\n"
        "   A: Потому что мы даем ПОЛНУЮ информацию, не урезанную!\n\n"
        ...
        "   Q: Есть ли примеры в ответах?\n"
        "   A: ДА! Реальные примеры, кейсы и практика везде!\n\n"
